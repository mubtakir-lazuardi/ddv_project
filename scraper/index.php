...
<?php
  ...
  if (isset($_POST['email'])) {
    if ($_POST['email'] === $emailAdmin && $_POST['password'] === $passAdmin) {
      ...
      header('Location: models/template/dashboard.php');
    }
    else{
...
<div class="container">
  <div id="login" class="login">
    <div class="login-icon-field">
      <center><img src="assets/image/logo2.png" style="width:55%; margin-top:50px;"></center>
    </div>
    <div class="login-form">
      <form method="post">
          <div class="username-row row">
            ...
            <input type="text" id="username_input" class="username-input" placeholder="Email" name="email" style="color:#fff"></input>
          </div>
          <div class="password-row row">
            ...
            <input type="password" id="password_input" class="password-input" name="password" class="input" placeholder="Password"></input>
          </div>
        </div>
